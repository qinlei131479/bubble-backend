    ...
    <div class="layout-padding-auto layout-padding-view">
      ...
      <el-table :data="state.dataList" v-loading="state.loading" border 
        ...
        <el-table-column type="index" label="#" width="40" />
          <el-table-column prop="supplierId" label="ai供应商表(ai_supplier)的Id"  show-overflow-tooltip/>
          <el-table-column prop="name" label="模型名称（供应商名称）"  show-overflow-tooltip/>
          <el-table-column prop="baseModel" label="模型名称（别名）"  show-overflow-tooltip/>
          <el-table-column prop="modelType" label="模型类型: 1:聊天, 2:推理, 3:向量，4：排序，5：图片，6：视觉"  show-overflow-tooltip/>
          <el-table-column prop="contextLength" label="模型上下文长度"  show-overflow-tooltip/>
          <el-table-column prop="description" label="模型描述"  show-overflow-tooltip/>
          <el-table-column prop="defaultFlag" label="默认模型，0：否，1：是"  show-overflow-tooltip/>
          <el-table-column prop="extConfig" label="模型扩展配置"  show-overflow-tooltip/>
        <el-table-column label="操作" width="150">
          <template #default="scope">
            ...
            <el-button icon="delete" text type="primary" v-auth="'agi_supplierModel_del'" @click="handleDelete([scope.row.id])">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
